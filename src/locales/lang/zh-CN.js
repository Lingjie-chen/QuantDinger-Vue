...
const locale = {
  ...
  'menu.dashboard.autonomousTrading': '自主交易控制台',
  'menu.dashboard.riskPanel': '风控面板',
  'menu.dashboard.evolution': '策略进化引擎',
  'menu.dashboard.tradeRecords': '交易记录',
  'menu.dashboard.quantWorkflow': '量化工作流',
  'menu.dashboard.performance': '绩效分析',
  'menu.dashboard.compositeIndicators': '复合指标',
  'menu.dashboard.hotParams': '热参数管理',
  'menu.dashboard.scheduler': '调度管理',
  'menu.dashboard.reconciliation': '对账管理',
